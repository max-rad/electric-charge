  ...
  _createClass(Accordion, [{
    ...
    value: function _documentClickHandler(evt) {
      ...
      if (target.closest('[data-accordion="link"]')) {
        var link = target.closest('[data-accordion="link"]').href;
        ...
        if (target.closest('[data-accordion="link"]')) {
          var _link = target.closest('[data-accordion="link"]').href;
    ...
    value: function _setSelectItemAction(item, index) {
      ...
      if (item.getAttribute('aria-selected') === 'true') {
        ...
        if (item.closest('[data-select-ajax]')) {
          ...
          var formData = 'sortten=' + item.dataset.selectValue;
...
/***/ "./js/modules/filter/init-filter.js":
/*!******************************************!*\
  !*** ./js/modules/filter/init-filter.js ***!
  \******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initFilter: function() { return /* binding */ initFilter; }
/* harmony export */ });
/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter */ "./js/modules/filter/filter.js");
...
var initRecaptcha = function initRecaptcha() {
  ...
  forms.forEach(function (form) {
    ...
    grecaptcha.ready(function () {
      grecaptcha.execute('6LdmI4YpAAAAABJ0YUZS-VzsryFK2f56McQ2kPPt', {
        action: 'submit'
      }).then(function (token) {
...
var breakpointMedia = window.matchMedia('(max-width: 1023px)');
var list = null;
var items = null;
var button = null;
...
/***/ "./js/modules/sliders/init-categories-slider.js":
/*!******************************************************!*\
  !*** ./js/modules/sliders/init-categories-slider.js ***!
  \******************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCategoriesSlider: function() { return /* binding */ initCategoriesSlider; }
/* harmony export */ });
var initCategoriesSlider = function initCategoriesSlider() {
  var slider = document.querySelector('[data-slider="categories"]');
  if (!slider) {
    return;
  }
  var controls = document.querySelector('[data-buttons="categories"]');
  var controlPrev = controls.querySelector('[data-button-prev]');
  var controlNext = controls.querySelector('[data-button-next]');
...
/***/ "./js/modules/sliders/init-gallery-slider.js":
/*!***************************************************!*\
  !*** ./js/modules/sliders/init-gallery-slider.js ***!
  \***************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var initGallerySlider = function initGallerySlider() {
  var slider = document.querySelector('[data-slider-gallery="main"]');
  var thumbs = document.querySelector('[data-slider-gallery="thumbs"]');
  if (!slider) {
    return;
  }
  var controls = document.querySelector('[data-buttons="thumbs"]');
  var controlPrev = controls.querySelector('[data-button-prev]');
  var controlNext = controls.querySelector('[data-button-next]');
...
/***/ "./js/modules/sliders/init-recommend-slider.js":
/*!*****************************************************!*\
  !*** ./js/modules/sliders/init-recommend-slider.js ***!
  \*****************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initRecommendSlider: function() { return /* binding */ initRecommendSlider; }
/* harmony export */ });
var initRecommendSlider = function initRecommendSlider() {
  var slider = document.querySelector('[data-slider="recommend"]');
  if (!slider) {
    return;
  }
  var controls = document.querySelector('[data-buttons="recommend"]');
  var controlPrev = controls.querySelector('[data-button-prev]');
  var controlNext = controls.querySelector('[data-button-next]');
  var swiper = new Swiper(slider, {
    slidesPerView: 1,
...
/***/ "./js/modules/sliders/init-watched-slider.js":
/*!***************************************************!*\
  !*** ./js/modules/sliders/init-watched-slider.js ***!
  \***************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initWatchedSlider: function() { return /* binding */ initWatchedSlider; }
/* harmony export */ });
var initWatchedSlider = function initWatchedSlider() {
  var slider = document.querySelector('[data-slider="watched"]');
  if (!slider) {
    return;
  }
  var controls = document.querySelector('[data-buttons="watched"]');
  var controlPrev = controls.querySelector('[data-button-prev]');
  var controlNext = controls.querySelector('[data-button-next]');
  var swiper = new Swiper(slider, {
    slidesPerView: 1,
...
/* harmony import */ var _modules_sliders_init_intro_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/sliders/init-intro-slider */ "./js/modules/sliders/init-intro-slider.js");
/* harmony import */ var _modules_sliders_init_categories_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/sliders/init-categories-slider */ "./js/modules/sliders/init-categories-slider.js");
/* harmony import */ var _modules_sliders_init_recommend_slider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/sliders/init-recommend-slider */ "./js/modules/sliders/init-recommend-slider.js");
/* harmony import */ var _modules_sliders_init_watched_slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/sliders/init-watched-slider */ "./js/modules/sliders/init-watched-slider.js");
/* harmony import */ var _modules_filter_init_filter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/filter/init-filter */ "./js/modules/filter/init-filter.js");
/* harmony import */ var _modules_sliders_init_gallery_slider__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/sliders/init-gallery-slider */ "./js/modules/sliders/init-gallery-slider.js");
/* harmony import */ var _modules_init_show_more__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/init-show-more */ "./js/modules/init-show-more.js");
/* harmony import */ var _modules_init_recaptcha__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/init-recaptcha */ "./js/modules/init-recaptcha.js");
...
window.addEventListener('DOMContentLoaded', function () {
  (0,_modules_init_recaptcha__WEBPACK_IMPORTED_MODULE_13__.initRecaptcha)();
  ...
  (0,_modules_sliders_init_intro_slider__WEBPACK_IMPORTED_MODULE_6__.initIntroSlider)();
  ...
  (0,_modules_init_show_more__WEBPACK_IMPORTED_MODULE_12__.initShowMore)();
  window.addEventListener('load', function () {
    (0,_modules_filter_init_filter__WEBPACK_IMPORTED_MODULE_10__.initFilter)();
    (0,_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_0__.initAccordion)();
    (0,_modules_sliders_init_categories_slider__WEBPACK_IMPORTED_MODULE_7__.initCategoriesSlider)();
    (0,_modules_sliders_init_recommend_slider__WEBPACK_IMPORTED_MODULE_8__.initRecommendSlider)();
    (0,_modules_sliders_init_watched_slider__WEBPACK_IMPORTED_MODULE_9__.initWatchedSlider)();
    (0,_modules_sliders_init_gallery_slider__WEBPACK_IMPORTED_MODULE_11__.initGallerySlider)();
  });
});
}();
/******/ })()
